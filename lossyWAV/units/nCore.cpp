...
==============================================================================
    ...
    Copyright (C) Tyge L�vset (tycho), Aug. 2012
===========================================================================**/
...
bool parameters_correction()
{
    return parameters.correction;
}

void set_parameters_correction(bool value)
{
    parameters.correction = value;
}

void set_global_blocks_processed(int32_t value)
{
    Global.blocks_processed = value;
}

bool global_last_codec_block()
{
    return Global.last_codec_block;
}

void set_global_last_codec_block(bool value)
{
    Global.last_codec_block = value;
}

bool global_first_codec_block()
{
    return Global.first_codec_block;
}

void set_global_first_codec_block(bool value)
{
    Global.first_codec_block = value;
}

int32_t audio_data_size_next()
{
    return AudioData.Size.Next;
}

bool parameters_is_merging()
{
    return parameters.merging;
}

int32_t global_codec_block_size()
{
    return Global.Codec_Block.Size;
}

void lossyWAVError(const std::string& lwe_string, int32_t lwe_value)
{
