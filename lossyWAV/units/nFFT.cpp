...
==============================================================================
 ...
 2012 Aug [Tyge L�vset (tycho), Aug. 2012]
...
void Radix_04FS_DIT(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    tDComplex Y3 = tDComplex_divided_by_i(this_FFT_plan->DComplex[1] - this_FFT_plan->DComplex[3]);
...
void Radix_04RS_DIT(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    tDComplex Y1 = (this_FFT_plan->DComplex[1] + this_FFT_plan->DComplex[3]);
    tDComplex Y2 = (this_FFT_plan->DComplex[0] - this_FFT_plan->DComplex[2]);
    tDComplex Y3 = tDComplex_multiplied_by_i(this_FFT_plan->DComplex[1] - this_FFT_plan->DComplex[3]);
...
void Radix_04F_DIT(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    for (int32_t i = 0; i < this_FFT_plan->FFT->length; i += BlockLength)
    {
        ...
        tDComplex Y1 = (V1 + V3);
        tDComplex Y2 = (V0 - V2);
        tDComplex Y3 = tDComplex_divided_by_i(V1 - V3);
...
void Radix_04R_DIT(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    for (int32_t i = 0; i < this_FFT_plan->FFT->length; i += BlockLength)
    {
        ...
        tDComplex Y1 = (V1 + V3);
        tDComplex Y2 = (V0 - V2);
        tDComplex Y3 = tDComplex_multiplied_by_i(V1 - V3);
...
//    tDComplex Z0 = (Y0 + Y1);
    ...
    tDComplex Z3 = (X4 - Y2);
//    tDComplex Z4 = (Y0 - Y1);
    tDComplex Z5 = tDComplex_divided_by_i(Y3 + X6);
    tDComplex Z6 = tDComplex_divided_by_i(X5 - X7);
    tDComplex Z7 = tDComplex_divided_by_i(Y3 - X6);
...
//    tDComplex Z0 = (Y0 + Y1);
    ...
    tDComplex Z3 = (X4 - Y2);
//    tDComplex Z4 = (Y0 - Y1);
    tDComplex Z5 = tDComplex_multiplied_by_i(Y3 + X6);
    tDComplex Z6 = tDComplex_multiplied_by_i(X5 - X7);
    tDComplex Z7 = tDComplex_multiplied_by_i(Y3 - X6);
...
//    tDComplex y8 = (y08 - y0_8);
    ...
    tDComplex z1 = tDComplex_divided_by_i(z91 + z1_9);
    tDComplex z2 = tDComplex_divided_by_i(z62 + x2a_e6);
    tDComplex z3 = tDComplex_divided_by_i(zb3 + z3_b);
    tDComplex z4 = tDComplex_divided_by_i(x19_f7 - x3b_d5);
    tDComplex z6 = tDComplex_divided_by_i(z62 - x2a_e6);
    tDComplex z9 = tDComplex_divided_by_i(z91 - z1_9);
    tDComplex zb = tDComplex_divided_by_i(zb3 - z3_b);
...
//    tDComplex y8 = (y08 - y0_8);
    ...
    tDComplex z1 = tDComplex_multiplied_by_i(z91 + z1_9);
    tDComplex z2 = tDComplex_multiplied_by_i(z62 + x2a_e6);
    tDComplex z3 = tDComplex_multiplied_by_i(zb3 + z3_b);
    tDComplex z4 = tDComplex_multiplied_by_i(x19_f7 - x3b_d5);
    tDComplex z6 = tDComplex_multiplied_by_i(z62 - x2a_e6);
    tDComplex z9 = tDComplex_multiplied_by_i(z91 - z1_9);
    tDComplex zb = tDComplex_multiplied_by_i(zb3 - z3_b);
...
void FFT_DIT_Complex(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    if (this_FFT_plan->NumberOfBitsNeeded>4)
    {
        ...
        for (sp_i = 1; sp_i < this_FFT_plan->FFT->length; sp_i++)
        {
            ...
            if (sp_i < sp_j)
                std::swap(this_FFT_plan->DComplex[sp_i],this_FFT_plan->DComplex[sp_j]);
        }
    }
...
void FFT_DIT_Real(FFT_Proc_Rec* this_FFT_plan)
{
    ...
    for (int32_t J = 1; J <= this_FFT_plan->FFT->length_half; J++)
    {
        ...
        tDComplex V = tDComplex(X0.imag(), -X1.real()) * this_A_Arr[D0];

        tDComplex W = tDComplex(X0.real(), X1.imag());

        this_FFT_plan->DComplex[D0] = (W + V);

        this_FFT_plan->DComplex[D2] = (W - V);

        this_FFT_plan->DComplex[D3--] = std::conj(this_FFT_plan->DComplex[D0++]);

        this_FFT_plan->DComplex[D1--] = std::conj(this_FFT_plan->DComplex[D2++]);
    }

    this_FFT_plan->DComplex[this_FFT_plan->FFT->length] = tDComplex(this_FFT_plan->DComplex[0].real() - this_FFT_plan->DComplex[0].imag(), 0.);

    this_FFT_plan->DComplex[0] = tDComplex(this_FFT_plan->DComplex[0].real() + this_FFT_plan->DComplex[0].imag(), 0.);
...
void nFFT_Init(int32_t desired_max_fft_bit_length)
{
    ...
    {
        A_Arr[nFFT_MAX_FFT_BIT_LENGTH][nf_j] = tDComplex_complex_exp(nf_j*delta);
        A_Arr_Conj[nFFT_MAX_FFT_BIT_LENGTH][nf_j] = std::conj(A_Arr[nFFT_MAX_FFT_BIT_LENGTH][nf_j]);
    }
    //=========================================================================================================================
    ...
    for (int32_t nf_i = 0; nf_i < nFFT_MAX_FFT_BIT_LENGTH; nf_i++)
    {
        for (int32_t nf_j = 0; nf_j < (1 << nf_i); nf_j++)
        {
            ...
            A_Arr_Conj[nf_i][nf_j] = std::conj(A_Arr[nf_i][nf_j]);
        }
