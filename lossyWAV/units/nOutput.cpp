...
void lsb_analysis()
{
    for (int32_t sa_j = 0; sa_j < Global.Channels; sa_j ++)
    {
        ...
        {
            int32_t temp_val = std::abs(AudioData.WAVEPTR[THIS_CODEC_BLOCK][sa_j][sa_i].Integers[0]);
        ...
        for (int32_t sa_i = 0; sa_i < AudioData.Size.This; sa_i ++)
        {
            int32_t temp_val = std::abs(AudioData.BTRDPTR[THIS_CODEC_BLOCK][sa_j][sa_i].Integers[0]);
        ...
        for (int32_t sa_i = 0; sa_i < AudioData.Size.This; sa_i ++)
        {
            int32_t temp_val = std::abs(AudioData.CORRPTR[THIS_CODEC_BLOCK][sa_j][sa_i].Integers[0]);
