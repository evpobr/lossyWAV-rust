...
void Initialise_FFTW_DLL(const char* this_DLL)
{
    ...
    {
        FFTW.Plan_DFT_r2c_1d = (void*(*)(int,double*,double*,uint32_t)) (void *) GetProcAddress(FFTW_DLL_Handle, "fftw_plan_dft_r2c_1d");
        FFTW.Plan_DFT_1d = (void*(*)(int,double*,double*,int,uint32_t)) (void *) GetProcAddress(FFTW_DLL_Handle, "fftw_plan_dft_1d");

        FFTW.Execute_R2C_New_Array = (void(*)(void*, double*, double*)) (void *) GetProcAddress(FFTW_DLL_Handle, "fftw_execute_dft_r2c");
        FFTW.Execute_C2C_New_Array = (void(*)(void*, double*, double*)) (void *) GetProcAddress(FFTW_DLL_Handle, "fftw_execute_dft");

        FFTW.Destroy_Plan = (void(*)(void*)) (void *) GetProcAddress(FFTW_DLL_Handle, "fftw_destroy_plan");
    }
